...
This is the 'model' part of the MVC. Here we represent the state of the 
program. Essentially think of the 'board' variable in our noughts and crosses
game. That wasn't the actual board, rather a mutable data structure. That data 
structure is what we create here
...
class snake:
	def __init__(self, head, tail, direction):
		...
		self.body = [self.head] #use this to store all the squares that currently make 
		               #up the snake
